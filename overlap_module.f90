...
CONTAINS
   ...
   END SUBROUTINE poly_poly_int3D
    ...
    REAL(RK), DIMENSION(maxCrnrs) :: CrnrDist, fDist
    REAL(RK) :: maxDist, minDist
    INTEGER :: c, f, e

    TYPE(VECTOR_TYPE) :: Crnr
    INTEGER :: n, nCrnr
    ...
    INTEGER :: newC, newE, last_newE, numE, nOrigC
    INTEGER :: nEdgeBehind

    INTEGER :: PolyiP1, PolyiP2
    INTEGER :: IntiP1, IntiP2, last_IntiP1, last_IntiP2
    INTEGER :: oldE, last_oldE, Polyf, Intf
...
!  small_dist = S100 * SPACING( S1 )
  ...
  SUBROUTINE Print_Poly_Mathematica (Poly)
   ...
   INTEGER :: nn, face, edge, e, iv1, iv2
